...
<aside class="sidebar" style="position: fixed; height: 100%; top: 0; left: 0;">
    ...
    <a href="../../public/index.html" style="display:block; padding:10px; color:white; text-decoration:none;">Dashboard</a>
    <a href="../../public/pokedex.html" style="display:block; padding:10px; color:white; text-decoration:none;">Pokédex</a>
    <a href="dmgCalcPage.php" style="display:block; padding:10px; color:white; text-decoration:none; background: #333;">Calculator</a>
</aside>
...
<main class="main" style="margin-left: 220px;"> 
    <div class="container">
        ...
        <form method="POST" action="../api/dmgCalc.php">
        ...
        <div class="result-box">
            ...
            <?php else: ?>
                <p id="damage-display">Damage will be displayed here</p>
            <?php endif; ?>
        </div>
